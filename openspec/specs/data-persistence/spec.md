...
## Purpose
Persist configuration, collections, requests, assertions, and environments as human-readable JSON in a defined, user-scoped layout with atomic, resilient I/O.
